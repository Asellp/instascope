<template>
  <div class="auth-layout">
    <!-- Hero Card Tarzı Ambians Işıkları -->
      ...
      <form @submit.prevent="handleLogin" class="auth-form">
        <div class="form-group">
          ...
          <div class="input-wrapper">
            ...
            <input v-model="email" type="email" placeholder="admin@instascope.io" required />
          </div>
        </div>
...
const email = ref('admin@instascope.io')
...
const handleLogin = async () => {
  ...
  try {
    ...
    errorMessage.value = err.message || 'Giriş yapılamadı.'
  } finally {
    loading.value = false
  }
}
...
[data-theme="light"] .test-credentials code {
  color: #1e293b;
}
</style>